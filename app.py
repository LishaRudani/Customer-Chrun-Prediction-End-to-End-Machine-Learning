...
def predict():
    if request.method == 'POST':
        ...
        if prediction == 1:
            return render_template('C1.html', prediction_text="The Customer will leave the bank")
        else:
            return render_template('C1.html', prediction_text="The Customer will not leave the bank")
